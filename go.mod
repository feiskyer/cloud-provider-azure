...
require (
	...
	sigs.k8s.io/cloud-provider-azure/pkg/azclient v0.8.1
	sigs.k8s.io/cloud-provider-azure/pkg/azclient/cache v0.7.1
	sigs.k8s.io/cloud-provider-azure/pkg/azclient/configloader v0.7.0
